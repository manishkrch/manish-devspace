...
const AboutMe: React.FC = () => {
  ...
  return (
    ...
    <div className="container">
      <div className="profile-teaser media flex-column flex-lg-row align-items-center align-items-lg-start">
        <div className="media-body w-100">
          ...
          <div className="mb-4 d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center">
            <Link className="btn btn-primary mr-0 mr-sm-2 mb-3 mb-sm-0" to="/portfolio"><i className="fas fa-arrow-alt-circle-right mr-2"></i><span className="d-none d-md-inline">View</span> Portfolio</Link>
            <Link className="btn btn-secondary" to="/resume"><i className="fas fa-file-alt mr-2"></i><span className="d-none d-md-inline">View</span> Resume</Link>
          </div>
        </div>
        <img
          className="profile-image mb-3 mb-lg-0 ml-lg-5 mr-md-0 rounded mx-auto d-block"
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="item col-12 col-sm-6 col-lg-3 mb-4">
      ...
      <div className="row mt-4">
        <div className="item col-12 col-sm-6 col-lg-3 mb-4">
          <div className="item-inner h-100">
            <div className="item-icon mb-2 d-flex flex-wrap align-items-center">
              ...
              <div className="item-inner w-100 d-flex flex-column justify-content-between">
                ...
                <div className="source-holder mt-3 d-flex align-items-center">
                  <div className="source-profile mr-3">
                    <img src={t.image} alt={t.name} style={{ maxWidth: 48, width: '100%', height: 'auto' }} />
                  </div>
                  <div className="meta">
          ...
          <div className="col-12 col-md-6 mb-5" key={idx}>
            <div className="card project-card h-100">
              <div className="row no-gutters flex-column flex-lg-row">
                <div className="col-12 col-lg-4 card-img-holder mb-3 mb-lg-0">
                  <img src={project.image} className="card-img w-100" alt={project.title} style={{ objectFit: 'cover', maxHeight: 180 }} />
                </div>
