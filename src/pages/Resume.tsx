			...
			<article className="resume-wrapper mx-auto theme-bg-light p-5 mb-5 my-5 shadow-lg">
				...
				<div className="resume-intro py-3">
					<div className="media flex-column flex-md-row align-items-center">
						<img className="resume-profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto" src="assets/images/resume-profile.png" alt="image" />
							...
							<section className="work-section py-3">
								...
								<div className="item mb-3">
									<div className="item-heading row align-items-center mb-2">
										...
										<div className="item-meta col-12 col-md-6 col-lg-4 text-muted text-left text-md-right">Google | 2019 - Present</div>
